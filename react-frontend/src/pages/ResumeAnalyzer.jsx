...
export default function ResumeAnalyzer() {
  ...
  const subMeters = [
    ...
    { label: 'Action Verb & Impact Metrics', val: 62, color: '#ef4444' },
    { label: 'Section Balance & Structure', val: 91, color: '#10b981' },
    { label: 'Target Keyword Density', val: 73, color: '#f59e0b' }
  ];
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.5rem' }}>
        <div>
          ...
          <p style={{ fontSize: '0.92rem', color: '#94a3b8', margin: 0 }}>
            Real-time ATS score, 5 sub-metric evaluations, and AI improvement queue.
          </p>
        </div>
